...
(function ($) {
  ...
  var barcode = {
    ...
    intval: function(val){
      ...
      return type == 'number' && isFinite(val) ? val : 0;
      //console.log(t);
    ...
    digitToCssRenderer : function($container, settings, digit, hri, mw, mh){
      ...
      if (settings.showHRI){
        content += "<div style=\"clear:both; width: 100%; background-color: " + settings.bgColor + "; color: " + settings.color + "; text-align: center; font-size: " + settings.fontSize + "px; padding-top: " + settings.marginHRI + "px;\">"+hri+"</div>";
      }
